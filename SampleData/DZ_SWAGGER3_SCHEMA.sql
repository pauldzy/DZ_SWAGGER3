...
Insert into DZ_SWAGGER3_SCHEMA
 ...
 Values
   ('Sample.property.areas_of_interest', 'scalar', 'Areas Of Interest', 'string', 'Unique Identifier for a project within the assigned grant', 
    'TRUE', TO_DATE('11/7/2020', 'MM/DD/YYYY'), 'pdziemie', 'SAMPLE');
Insert into DZ_SWAGGER3_SCHEMA
   (SCHEMA_ID, SCHEMA_CATEGORY, SCHEMA_TITLE, SCHEMA_TYPE, SCHEMA_DESCRIPTION, 
...
Insert into DZ_SWAGGER3_SCHEMA
   (SCHEMA_ID, SCHEMA_CATEGORY, SCHEMA_TITLE, SCHEMA_TYPE, SCHEMA_DESCRIPTION, 
    SCHEMA_NULLABLE, SCHEMA_DESC_UPDATED, SCHEMA_DESC_AUTHOR, VERSIONID)
 Values
   ('Sample.property.identifier_summary', 'scalar', 'Identifier Summary', 'string', 'Unique Identifier for a project within the assigned grant', 
    'TRUE', TO_DATE('11/7/2020', 'MM/DD/YYYY'), 'pdziemie', 'SAMPLE');
Insert into DZ_SWAGGER3_SCHEMA
   (SCHEMA_ID, SCHEMA_CATEGORY, SCHEMA_TITLE, SCHEMA_TYPE, SCHEMA_DESCRIPTION, 
    SCHEMA_NULLABLE, SCHEMA_EXAMPLE_STRING, SCHEMA_DESC_UPDATED, SCHEMA_DESC_AUTHOR, VERSIONID)
...
Insert into DZ_SWAGGER3_SCHEMA
   (SCHEMA_ID, SCHEMA_CATEGORY, SCHEMA_TITLE, SCHEMA_TYPE, SCHEMA_DESCRIPTION, 
    SCHEMA_NULLABLE, SCHEMA_DESC_UPDATED, SCHEMA_DESC_AUTHOR, VERSIONID)
 Values
   ('Sample.property.landscape_layers', 'scalar', 'Landscape Layers', 'string', 'Unique Identifier for a project within the assigned grant', 
    'TRUE', TO_DATE('11/7/2020', 'MM/DD/YYYY'), 'pdziemie', 'SAMPLE');
Insert into DZ_SWAGGER3_SCHEMA
   (SCHEMA_ID, SCHEMA_CATEGORY, SCHEMA_TITLE, SCHEMA_TYPE, SCHEMA_DESCRIPTION, 
    SCHEMA_NULLABLE, SCHEMA_EXAMPLE_NUMBER, SCHEMA_DESC_UPDATED, SCHEMA_DESC_AUTHOR, VERSIONID)
...
Insert into DZ_SWAGGER3_SCHEMA
   (SCHEMA_ID, SCHEMA_CATEGORY, SCHEMA_TITLE, SCHEMA_TYPE, SCHEMA_DESCRIPTION, 
    SCHEMA_NULLABLE, SCHEMA_DESC_UPDATED, SCHEMA_DESC_AUTHOR, VERSIONID)
 Values
   ('Sample.property.metrics', 'scalar', 'Metrics', 'string', 'Unique Identifier for a project within the assigned grant', 
    'TRUE', TO_DATE('11/7/2020', 'MM/DD/YYYY'), 'pdziemie', 'SAMPLE');
Insert into DZ_SWAGGER3_SCHEMA
   (SCHEMA_ID, SCHEMA_CATEGORY, SCHEMA_TITLE, SCHEMA_TYPE, SCHEMA_NULLABLE, 
    SCHEMA_EXAMPLE_STRING, SCHEMA_DESC_UPDATED, SCHEMA_DESC_AUTHOR, VERSIONID)
...
Insert into DZ_SWAGGER3_SCHEMA
 ...
 Values
   ('Sample.property.return_code', 'scalar', 'Return Code', 'integer', 'An integer code that is used to determine the nature of an error, and why it occurred.  A value of zero indicates success.', 
    'TRUE', 0, TO_DATE('3/23/2021', 'MM/DD/YYYY'), 'pdziemie', 'SAMPLE');
Insert into DZ_SWAGGER3_SCHEMA
   (SCHEMA_ID, SCHEMA_CATEGORY, SCHEMA_TITLE, SCHEMA_TYPE, SCHEMA_DESCRIPTION, 
    SCHEMA_NULLABLE, SCHEMA_DESC_UPDATED, SCHEMA_DESC_AUTHOR, VERSIONID)
 Values
   ('Sample.property.search_criteria', 'scalar', 'Search Criteria', 'string', 'Unique Identifier for a project within the assigned grant', 
    'TRUE', TO_DATE('11/7/2020', 'MM/DD/YYYY'), 'pdziemie', 'SAMPLE');
Insert into DZ_SWAGGER3_SCHEMA
   (SCHEMA_ID, SCHEMA_CATEGORY, SCHEMA_TITLE, SCHEMA_TYPE, SCHEMA_DESCRIPTION, 
    SCHEMA_NULLABLE, SCHEMA_EXAMPLE_NUMBER, SCHEMA_DESC_UPDATED, SCHEMA_DESC_AUTHOR, VERSIONID)
