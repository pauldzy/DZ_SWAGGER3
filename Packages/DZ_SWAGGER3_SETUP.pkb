...
AS
   ...
   BEGIN
      ...
      -- Build HEAD table
      --------------------------------------------------------------------------
      str_sql := 'CREATE TABLE dz_swagger3_head('
      ...
      str_sql := 'ALTER TABLE dz_swagger3_head '
              || 'ADD CONSTRAINT dz_swagger3_head_pk '
      ...
      str_sql := 'ALTER TABLE dz_swagger3_head '
              || 'ADD( '
              || '    CONSTRAINT dz_swagger3_head_c01 '
              || '    CHECK (header_id = TRIM(header_id)) '
              || '    ENABLE VALIDATE '
              || '   ,CONSTRAINT dz_swagger3_head_c02 '
              || '    CHECK (versionid = TRIM(versionid)) '
              || '    ENABLE VALIDATE '
              || ') ';
      ...
      str_sql := 'ALTER TABLE dz_swagger3_server '
              ...
              || 'PRIMARY KEY(versionid,header_id,server_url) ';
